...
public class NewsController {
    ...
    public ApiResult addNews(@RequestBody News news) {
        ...
        news.setDeleted("N");
        news.setPublicTime(Timestamp.valueOf(LocalDateTime.now()));
    ...
    @ResponseBody
    @RequestMapping(value = "/gethotnews", method = GET)
    @ApiOperation("获取热点新闻数据")
    public ApiResult getHotNews(String hot) {

        return newsService.getHotNews(hot);
    }
